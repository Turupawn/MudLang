...
library ContractCounter {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "app", name: "ContractCounter", typeId: RESOURCE_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x74626170700000000000000000000000436f6e7472616374436f756e74657200);
